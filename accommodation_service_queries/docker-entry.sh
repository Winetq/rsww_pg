...
jar xf accommodation_service_queries.jar BOOT-INF/classes/database.properties
...
jar uf accommodation_service_queries.jar BOOT-INF/classes/database.properties

jar xf accommodation_service_queries.jar BOOT-INF/classes/application.properties
...
jar uf accommodation_service_queries.jar BOOT-INF/classes/application.properties

java -jar accommodation_service_queries.jar
